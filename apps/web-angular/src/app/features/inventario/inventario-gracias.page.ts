...
@Component({
  selector: 'app-inventario-gracias-page',
  imports: [],
  templateUrl: './inventario-gracias.page.html',
  styleUrl: './inventario-gracias.page.scss',
})
export class InventarioGraciasPage implements OnInit, OnDestroy {
