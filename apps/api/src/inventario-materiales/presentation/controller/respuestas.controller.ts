...
import { ConfirmarPrecargaRequestDto } from '../../application/dto/confirmar-precarga.dto';
...
export class RespuestasController {
  public constructor(
    ...
    private readonly confirmarPrecarga: ConfirmarPrecargaUseCase,
  ) {}
  ...
  public async confirmarPrecargaEndpoint(
    @CurrentEmpleado() empleado: SessionEmpleado,
